<template>
	<view class="search">
		<MusicHead title="搜索" :icon='icon' :iconColor="iconColor"></MusicHead>
				...
				<view class="search-hot">
					...
					<!-- <view class="search-hot-item">
						...
						<view class="search-hot-word">
							<view>
								少年<image src="../../static/SQ.png" mode="aspectFit"></image>
							</view>
							<view>少年啊啊啊</view>
						</view>
					...
					<view class="search-hot-item" v-for="(item,index) in searchHot" :key='index' @tap="handleToWord(item.searchWord)">
						...
						<view class="search-hot-count">
							<text>{{item.score | formatCount}}</text>
						</view>
					</view>
				</view>
			</block>
			...
			<block v-else-if="searchType == 3">
				<view class="search-suggest">
					...
					<!-- <view class="search-suggest-item">
						<text class="iconfont icon-fangdajing"></text>少年抖音
					</view> -->
...
<style scoped>
	.search-search{display: flex;align-items: center;height: 70rpx;margin: 20rpx 30rpx 50rpx 30rpx;background: #f7f7f7;border-radius: 50rpx;}
	...
	.search-history-list view{padding: 16rpx 28rpx;border-radius: 50%;margin: 0 30rpx 30rpx 0;background: #f7f7f7;}
	...
	.search-result-word image{width: 30rpx;height: 20rpx;margin-right: 10rpx;margin-top: 2rpx;}
